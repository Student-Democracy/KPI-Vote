...
namespace UnitTests
{
    internal static class UnitTestHelper
    {
        ...
        public static void SeedData(ApplicationContext context)
        {
            ...
            context.SaveChanges();
            context.Groups.Add(new Group() { Number = 1, CreationDate = new DateTime(2021, 11, 14), Flow = context.Flows.FirstOrDefault(f => f.Name == "ІС-9") });
            context.Groups.Add(new Group() { Number = 2, CreationDate = new DateTime(2021, 11, 14), Flow = context.Flows.FirstOrDefault(f => f.Name == "ІС-9") });
            context.Groups.Add(new Group() { Number = 3, CreationDate = new DateTime(2021, 11, 14), Flow = context.Flows.FirstOrDefault(f => f.Name == "ІС-9") });
            context.Groups.Add(new Group() { Number = 1, CreationDate = new DateTime(2021, 11, 14), Flow = context.Flows.FirstOrDefault(f => f.Name == "ІС-0") });
            context.Groups.Add(new Group() { Number = 2, CreationDate = new DateTime(2021, 11, 14), Flow = context.Flows.FirstOrDefault(f => f.Name == "ІС-0") });
            context.Groups.Add(new Group() { Number = 3, CreationDate = new DateTime(2021, 11, 14), Flow = context.Flows.FirstOrDefault(f => f.Name == "ІС-0") });
            context.Groups.Add(new Group() { Number = 1, CreationDate = new DateTime(2021, 11, 14), Flow = context.Flows.FirstOrDefault(f => f.Name == "ІА-0") });
            context.Groups.Add(new Group() { Number = 2, CreationDate = new DateTime(2021, 11, 14), Flow = context.Flows.FirstOrDefault(f => f.Name == "ІА-0") });
            context.Groups.Add(new Group() { Number = 3, CreationDate = new DateTime(2021, 11, 14), Flow = context.Flows.FirstOrDefault(f => f.Name == "ІА-0") });
            context.Groups.Add(new Group() { Number = 4, CreationDate = new DateTime(2021, 11, 14), Flow = context.Flows.FirstOrDefault(f => f.Name == "ІА-0") });
            context.Groups.Add(new Group() { Number = 1, CreationDate = new DateTime(2021, 11, 14), Flow = context.Flows.FirstOrDefault(f => f.Name == "КВ-0") });
            context.Groups.Add(new Group() { Number = 2, CreationDate = new DateTime(2021, 11, 14), Flow = context.Flows.FirstOrDefault(f => f.Name == "КВ-0") });
            context.Groups.Add(new Group() { Number = 3, CreationDate = new DateTime(2021, 11, 14), Flow = context.Flows.FirstOrDefault(f => f.Name == "КВ-0") });
            context.SaveChanges();
            ...
            context.SaveChanges();
            context.Users.Add(new User() { FirstName = "Petro", LastName = "Petrenko", Patronymic = "Petrovich", Email = "petrenko1@gmail.com", TelegramTag = "@petrenko", PasswordHash = "sample1", PasswordChanged = false, RegistrationDate = new DateTime(2021, 11, 14), Group = context.Groups.FirstOrDefault(g => g.Number == 2 && g.Flow.Name == "ІС-0") });
            context.Users.Add(new User() { FirstName = "Ivan", LastName = "Petrenko", Patronymic = "Petrovich", Email = "petrenko2@gmail.com", TelegramTag = "@IPetrenko", PasswordHash = "sample1jjh", PasswordChanged = true, RegistrationDate = new DateTime(2021, 11, 14), Group = context.Groups.FirstOrDefault(g => g.Number == 2 && g.Flow.Name == "ІС-0") });
            context.Users.Add(new User() { FirstName = "Petro", LastName = "Ivanov", Patronymic = "Petrovich", Email = "ivanov@gmail.com", TelegramTag = "@ivanov", PasswordHash = "sample1fag", PasswordChanged = true, RegistrationDate = new DateTime(2021, 11, 14), Group = context.Groups.FirstOrDefault(g => g.Number == 2 && g.Flow.Name == "ІС-0") });
            context.Users.Add(new User() { FirstName = "Petro", LastName = "Petrenko", Patronymic = "Ivanovich", Email = "petrenko3@gmail.com", TelegramTag = "@PPI", PasswordHash = "sample1tnhgn", PasswordChanged = true, RegistrationDate = new DateTime(2021, 11, 14), Group = context.Groups.FirstOrDefault(g => g.Number == 2 && g.Flow.Name == "ІС-0") });
            context.Users.Add(new User() { FirstName = "Petro", LastName = "Sydorenko", Patronymic = "Sydorovich", Email = "sydorenko@gmail.com", TelegramTag = "@sydorenko", PasswordHash = "sample1", PasswordChanged = false, RegistrationDate = new DateTime(2021, 11, 14), Group = context.Groups.FirstOrDefault(g => g.Number == 2 && g.Flow.Name == "ІС-0") });
            context.Users.Add(new User() { FirstName = "Sydor", LastName = "Sydorenko", Patronymic = "Sydorovich", Email = "SSS@gmail.com", TelegramTag = "@SSS", PasswordHash = "sample1asd", PasswordChanged = true, RegistrationDate = new DateTime(2021, 11, 14), Group = context.Groups.FirstOrDefault(g => g.Number == 2 && g.Flow.Name == "ІС-0") });
            context.Users.Add(new User() { FirstName = "Petro", LastName = "Ivanov", Patronymic = "Ivanovych", Email = "pivo@gmail.com", TelegramTag = "@sydorenko", PasswordHash = "sdasdasdfdsf", PasswordChanged = true, RegistrationDate = new DateTime(2021, 11, 14), Group = context.Groups.FirstOrDefault(g => g.Number == 3 && g.Flow.Name == "КВ-0") });
            context.SaveChanges();
            ...
            context.SaveChanges();
            context.Bans.Add(new Ban() { DateFrom = new DateTime(2021, 11, 14), DateTo = new DateTime(2021, 11, 15), Hammer = "Ban hammer", Admin = context.Users.FirstOrDefault(user => user.Email == "petrenko1@gmail.com"), User = context.Users.FirstOrDefault(user => user.Email == "pivo@gmail.com") });
            context.SaveChanges();
